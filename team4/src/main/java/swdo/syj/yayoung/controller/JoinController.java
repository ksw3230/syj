...
public class JoinController {
	...
	public String insert_tc(
		...
		if (!upload.isEmpty()) {	//파일이 존재하면 false
			String savedfile = FileService.saveFile(upload, uploadPath_tc);	//파일의 정보와 그 것을 savedfile에 카피함
			tc.setTc_picname(upload.getOriginalFilename());	// db정보에 담아서
