...
public class TeacherVO {
	...
	public TeacherVO(String tc_id, String tc_pw, String tc_name, String tc_dob, String tc_phone, 
			String tc_email,String tc_picname, String tc_savedpicid) {
		super();
		this.tc_id = tc_id;
		this.tc_pw = tc_pw;
